...
# ===========================================================================
HOST = "sambitg31"   # shown as  sambitg31@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full-Stack + AI/ML Developer"),
    ("kv", "Focus", "React, FastAPI, Python, RL"),
    ("kv", "Hackathons", "Meta PyTorch x Scaler SST"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Vite, Tailwind CSS"),
    ("kv", "Backend", "FastAPI, Python, REST APIs"),
    ("kv", "AI / ML", "PyTorch, RL, HF Inference API"),
    ("kv", "Tools", "Docker, Git, Hugging Face"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "ReliefRoute AI - disaster response sim (OpenEnv)"),
    ("bul", "Blisst AI - accessible transport decision env"),
]
